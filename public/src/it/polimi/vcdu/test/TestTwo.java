...
//		Logger.getLogger("it.polimi.vcdu.alg").setLevel(Level.WARNING);
		...
		ControlParameters.getCurrentParameters().setMaxVirtualTime(500000f);
...
///* Experiment quiescence */
		...
		Component targetedComponent = conf.getComponentFromId("C2");
		exp_quiescence(conf,targetedComponent,RequestTime);

/* Experiment measurement */
		reInit();

		Configuration conf2 = new Configuration(configGraph);
		Component targetedComponent2 = conf2.getComponentFromId("C2");
