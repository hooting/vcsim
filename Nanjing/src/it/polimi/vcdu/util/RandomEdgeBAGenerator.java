 ...
 */
public class RandomEdgeBAGenerator<V,E> implements EvolvingGraphGenerator<V,E> {
    private Graph<V, E> mGraph = null;
    private int mNumEdgesToAttachPerStep;   // CHANGE MEANING! radomly choose a valude from 
    										// 1..mNumEdgesToAttachPerStep at each step!!!
     ...
     */
    public RandomEdgeBAGenerator(Factory<Graph<V,E>> graphFactory,
    ...
    private void initialize(Set<V> seedVertices) {
        ...
        for (int i = 0; i < init_vertices; i++) {
            ...
            // we don't want this ...
            //if(i>0) mGraph.addEdge(edgeFactory.create(), v, vertex_index.get(i-1));
        }
...
//        int nEdges = generator.nextInt(mNumEdgesToAttachPerStep)+1;
        
        int nEdges = mNumEdgesToAttachPerStep;
