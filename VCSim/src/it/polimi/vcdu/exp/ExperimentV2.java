...
public class ExperimentV2 {
	...
	public ExperimentV2(Graph<Number,Number> configGraph, String targetComponentName,float reqTime,boolean waitingVC){
	...
	public void run(){
		...
		this.expOnDemandVersConsistencyV2();
		reInit();
		this.expMeasuringQ();
		reInit();
		this.expMeasuringF();
	...
	public void expOnDemandVersConsistencyV2(){
		Configuration conf = new Configuration(configGraph);
		Component targetedComponent = conf.getComponentFromId(this.targetComponentName);
